 ...
 */
export const sendReservationConfirmedEmail = async (email, reservation, locker) => {
  const mailOptions = {
    from: FROM_EMAIL,
    to: email,
    ...
    html: `
      ...
      <table style="border-collapse: collapse; margin: 20px 0;">
        ...
        <tr>
          ...
          <td style="padding: 8px; border: 1px solid #ddd;">${formatDate(reservation.startDate)}</td>
        </tr>
        <tr>
 ...
 */
export const sendReservationReturnedEmail = async (email, reservation, locker) => {
  const mailOptions = {
    from: FROM_EMAIL,
    to: email,
