...
router.get(
    "/admin/lockers",
    renderPage("pages/admin/lockers", "Manage Lockers")
);

// Locker Management - Create Form
router.get(
    "/admin/lockers/new",
    renderPage("pages/admin/locker-form", "Create Locker", {
        locker: null,
        isEdit: false,
    })
);
...
router.get(
    "/admin/lockers/:id/edit",
    renderPageWithParams("pages/admin/locker-form", "Edit Locker", (req) => ({
...
router.get(
    "/admin/reservations",
    renderPage("pages/admin/reservations", "Manage Reservations")
);
